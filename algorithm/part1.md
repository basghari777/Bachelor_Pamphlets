...
**نکته:** مرتبه زمانی الگوریتم مرتب‌سازی ادغام در بهترین حالت و حالت متوسط و بدترین حالت $$ O(n\log_2 {n}) $$ می‌باشد.
...
**نکته:** مرتبه زمانی الگوریتم مرتب‌سازی سریع در بهترین حالت و حالت متوسط $$ O(n\Log_2 {n}) $$ در بدترین حالت $$ O(n^2) $$ می‌باشد. بدترین حالت زمانی است که آرایه از قبل مرتب باشد.
...
در این الگوریتم دنباله‌ای از اعداد تولید می‌شود که هر عدد با جمع دو عدد قبلی به دست می‌آید برای مثال برای محاسبه‌ی جمله‌ی بیستم دنباله‌ی فیبوناچی باید مقادیر 19 جمله قبلی محاسبه شود. مرتبه زمانی این الگوریتم $$ O(n^2) $$ از نوع نمایی می‌باشد. 